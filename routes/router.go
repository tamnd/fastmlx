...
func (rt *Router) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /v1/audio/transcriptions", rt.Transcribe)
	mux.HandleFunc("POST /v1/audio/speech", rt.Speech)
	mux.HandleFunc("POST /v1/audio/process", rt.AudioProcess)
